...
Open Document Skills is a shared skill pack for agents that understand `SKILL.md`-style capabilities.

Start here:

- [Installation](installation.md) - install for Codex, Claude Code, OpenCode, or a custom skills directory.
